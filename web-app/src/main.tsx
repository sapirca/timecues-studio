...
import { initMobileMode } from './mobile/mobileMode'
...
// Phone or desktop frame — decided once, before the first paint, so the CSS
// that depends on it (header height, sidebars-as-panels) never flashes.
initMobileMode()
